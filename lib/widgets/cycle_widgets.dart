                    ...
                    getTooltipItems: (touchedSpots) {
                      return touchedSpots.map((spot) {
                        ...
                        return LineTooltipItem(
                          ...
                          const TextStyle(color: AppTheme.textDark, fontWeight: FontWeight.w800, fontSize: 13),
                          children: [
                            TextSpan(
                              text: biology['insight'],
                              style: const TextStyle(color: AppTheme.textSecondary, fontWeight: FontWeight.w500, fontSize: 10),
                            ),
                          ],
                        );
                      }).toList();
